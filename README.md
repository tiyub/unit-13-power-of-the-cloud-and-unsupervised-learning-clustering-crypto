...
<sup><a id="ref001">1</a></sup> Matthias (2018-04-09). Pandas DataFrame: SettingWithCopyWarning: A value is trying to be set on a copy of a slice from a DataFrame. Retrieved from [pythonguides.com](https://stackoverflow.com/questions/49728421/pandas-dataframe-settingwithcopywarning-a-value-is-trying-to-be-set-on-a-copy#49728579).  

<sup><a id="ref002">2</a></sup> MichaelSteurer (2020-01-22). Renderer extension not being installed -- causes some packages not to work, like plotly.
#3936. Retrieved from [github.com](https://github.com/microsoft/vscode-jupyter/issues/3936).  
<blockquote style="border-left: 0px solid #ccc; color: rgb(88, 166, 255);"><details><summary>Disclose 2</summary>  

#### Due to VScode errror:  
